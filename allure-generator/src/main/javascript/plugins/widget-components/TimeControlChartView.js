import template from './TimeControlChartView.hbs';
import './styles.scss';
...
class TimeControlChartView extends View {
    template = template;
    ...
    getStatusChartData() {
        ...
        var total = 0;
        var unknown = 0;
        if(this.items[0].name === 'SE Time Control'){
...
export default TimeControlChartView;
