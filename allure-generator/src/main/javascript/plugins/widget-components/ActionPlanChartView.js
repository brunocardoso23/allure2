import './styles.scss';
import template from './ActionPlanChartView.hbs';
...
class ActionPlanChartView extends View {
    template = template;
    ...
    getStatusChartData() {
        ...
        var total = 0;
        var unknown = 0;
        if(this.items[0].name === 'SE Action Plan'){
...
export default ActionPlanChartView;
