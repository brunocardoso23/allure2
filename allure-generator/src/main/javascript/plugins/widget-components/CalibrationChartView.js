import template from './CalibrationChartView.hbs';
import './styles.scss';
...
class CalibrationChartView extends View {
    template = template;
    ...
    getStatusChartData() {
        ...
        var total = 0;
        var unknown = 0;
        if(this.items[0].name === 'SE Calibration'){
...
export default CalibrationChartView;
