import template from './MaintenanceChartView.hbs';
import './styles.scss';
...
class MaintenanceChartView extends View {
    template = template;
    ...
    getStatusChartData() {
        ...
        var total = 0;
        var unknown = 0;
        if(this.items[0].name === 'SE Maintenance'){
...
export default MaintenanceChartView;
