import template from './CompetenceChartView.hbs';
import './styles.scss';
...
class CompetenceChartView extends View {
    template = template;
    ...
    getStatusChartData() {
        ...
        var total = 0;
        var unknown = 0;
        if(this.items[0].name === 'SE Competence'){
...
export default CompetenceChartView;
