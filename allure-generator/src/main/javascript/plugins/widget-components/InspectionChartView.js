import template from './InspectionChartView.hbs';
import './styles.scss';
...
class InspectionChartView extends View {
    template = template;
    ...
    getStatusChartData() {
        ...
        var total = 0;
        var unknown = 0;
        if(this.items[0].name === 'SE Inspection'){
...
export default InspectionChartView;
