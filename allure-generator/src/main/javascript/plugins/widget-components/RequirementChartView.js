import template from './RequirementChartView.hbs';
import './styles.scss';
...
class RequirementChartView extends View {
    template = template;
    ...
    getStatusChartData() {
        ...
        var total = 0;
        var unknown = 0;
        if(this.items[0].name === 'SE Requirement'){
...
export default RequirementChartView;
