...
import TestResultOverviewViewJS from '../testresult-overview/TestResultOverviewViewJS';
...
const subViews = [
    {id: '', name: 'Log', View: TestResultOverviewViewJS}
];
...
class TestResultViewJS extends View {
    template = template;
...
export default TestResultViewJS;
