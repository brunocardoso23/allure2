...
import template from './TestResultExecutionViewJS.hbs';
...
class TestResultExecutionViewJS extends View {
    template = template;
...
export default TestResultExecutionViewJS;
